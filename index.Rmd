...
# When in export mode the little dots are unaligned, so fix that.
if (PDF_EXPORT) {
  cat("View this CV online with links at _sharla.party/cv_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/sharlagelfand/cv/raw/master/sharla_gelfand_cv.pdf)")
}
```
